package net.kanad.tutorialmod.world.biome.surface;
...
public class ModMaterialRules {
    ...
    private static final MaterialRules.MaterialRule CHESTNUT_GRASS_BLOCK = makeStateRule(ModBlocks.CHESTNUT_GRASS_BLOCK);
    ...
    public static MaterialRules.MaterialRule makeRules() {
        ...
        return MaterialRules.sequence(
                MaterialRules.sequence(MaterialRules.condition(MaterialRules.biome(ModBiomes.TEST_BIOME),
                                MaterialRules.condition(MaterialRules.STONE_DEPTH_FLOOR, CHESTNUT_GRASS_BLOCK)),
